...
#		os.makedirs(video_dir) 
	...
	video_number_of_frames = os.path.dirname(video_path) + "/../number_of_frames_video/" + video_name + ".etf"
	...
	DIR = '/data/torch/ltc/datasets/2kporn/rgb/jpg/' + video_name
	number_of_frames =  len([name for name in os.listdir(DIR) if os.path.isfile(os.path.join(DIR, name))])
	print number_of_frames

	with open(video_number_of_frames, "w") as f:
		f.write(str(number_of_frames)) 
