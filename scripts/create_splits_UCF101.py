...
#			extractFrames(dir_path, cpu_count, args)
	with open('/home/jp/EQM/torch/ltc/scripts/splits/classInd.txt') as f:
		content = f.readlines()
	
	for line in content:
		split_content = line.strip().split(' ')
		command = "mkdir " + os.path.join('/home/jp/EQM/torch/ltc/datasets/UCF101/splits/split1/train/', split_content[1])
		call(command, shell=True)
		command = "mkdir " + os.path.join('/home/jp/EQM/torch/ltc/datasets/UCF101/splits/split1/test/', split_content[1])
		call(command, shell=True)

	with open('/home/jp/EQM/torch/ltc/scripts/splits/trainlist01.txt') as f:
		content = f.readlines()
	
	for line in content:
		split_content = line.strip().split(' ')
		command = "touch " + os.path.join('/home/jp/EQM/torch/ltc/datasets/UCF101/splits/split1/train/', split_content[0])
		call(command, shell=True)

	with open('/home/jp/EQM/torch/ltc/scripts/splits/testlist01.txt') as f:
		content = f.readlines()
	
	for line in content:
		split_content = line.strip().split(' ')
		command = "touch " + os.path.join('/home/jp/EQM/torch/ltc/datasets/UCF101/splits/split1/test/', split_content[0])
		call(command, shell=True)
...
#		cpu_count = args.cpu_count
	...
	create_splits(args.videos_path, cpu_count, args)
